...
class Stm_Instagram_Widget extends WP_Widget {
	...
	function __construct() {
		...
		parent::__construct(
			'instagram', // Base ID
			__( 'Instagram', 'happychild' ), // Name
			array( 'description' => __( 'Instagram widget', 'happychild' ), ) // Args
		);
	}
	...
	public function widget( $args, $instance ) {
		...
		if ( ! empty( $instance['clientId'] ) ) {
			...
			if($instance['instagramToken']){
				...
				_e( 'Error Instagram Token', 'happychild' );
			}

		} else {
			_e( 'Error Client Id', 'happychild' );
		}
	...
	public function form( $instance ) {
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'posts' ); ?>"><?php _e( 'Number of posts to show:', 'happychild' ); ?></label>
        ...
        <p>
            <label for="<?php echo $this->get_field_id( 'cache' ); ?>"><?php _e( 'Cache: (h)', 'happychild' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'clientId' ); ?>"><?php _e( 'Client Id:', 'happychild' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'secret' ); ?>"><?php _e( 'Secret:', 'happychild' ); ?></label>
			<input class="widefat" id="<?php echo $this->get_field_id( 'secret' ); ?>" name="<?php echo $this->get_field_name( 'secret' ); ?>" type="text" value="<?php echo $secret; ?>">
		</p>
		<p>
			<label for="<?php echo $this->get_field_id( 'token' ); ?>"><?php _e( 'Token:', 'happychild' ); ?></label>
			<input class="widefat" id="<?php echo $this->get_field_id( 'instagramToken' ); ?>" name="<?php echo $this->get_field_name( 'instagramToken' ); ?>" type="text" value="<?php echo $token; ?>">
			<a href="<?php echo $instagram->getLoginUrl() ?>"> Request Token </a>
		</p>
	<?php
	}
