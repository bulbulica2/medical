				...
				<div class="theme_bg">
					<ul>
						<?php foreach ( $this->choices as $itemName => $itemLabel ): ?>
							<li class="<?php echo esc_attr( $itemName ); ?>" <?php if($itemLabel){ ?>style="background-image: url('<?php echo get_template_directory_uri(); ?>/assets/images/bg/<?php echo esc_attr( $itemLabel ); ?>.jpg')"<?php } ?>>
