...
class ST_PostType {
	...
	public static function registerPostType( $postType, $title, $args ) {
		...
		$labels      = array(
			'name'               => __( $pluralTitle, 'happychild' ),
			'singular_name'      => __( $title, 'happychild' ),
			'add_new'            => __( 'Add New', 'happychild' ),
			'add_new_item'       => __( 'Add New ' . $title, 'happychild' ),
			'edit_item'          => __( 'Edit ' . $title, 'happychild' ),
			'new_item'           => __( 'New ' . $title, 'happychild' ),
			'all_items'          => __( 'All ' . $pluralTitle, 'happychild' ),
			'view_item'          => __( 'View ' . $title, 'happychild' ),
			'search_items'       => __( 'Search ' . $pluralTitle, 'happychild' ),
			'not_found'          => __( 'No ' . $pluralTitle . ' found', 'happychild' ),
			'not_found_in_trash' => __( 'No ' . $pluralTitle . '  found in Trash', 'happychild' ),
			'parent_item_colon'  => '',
			'menu_name'          => __( $pluralTitle, 'happychild' )
		);
	...
	public static function addMetaBox(
		$id, $title, $post_type, $callback = '', $context = '',
		$priority = '', $callback_args = ''
	) {

		$title = empty( $title ) ? __( 'Options', 'happychild' ) : $title;
